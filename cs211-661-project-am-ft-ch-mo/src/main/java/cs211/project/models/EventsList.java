...
public class EventsList {
    ...
    public void addNewEvent(String eventName , String eventDetail, Integer maxSeat, String startDate, String finishDate, String eventImagePath, String eventCreatorUsername) {
        ...
        if (!eventName.equals("") && !eventDetail.equals("") && maxSeat!=null && !startDate.equals("") && !finishDate.equals("") && !eventImagePath.equals("") && !eventCreatorUsername.equals("") ) {
            ...
            if (exist == null) {
                events.add(new Events(eventName,eventDetail,maxSeat,startDate,finishDate,eventImagePath,eventCreatorUsername));
            }
        }
    }
    ...
    public void changeInfo(String eventName, String eventDetail, Integer maxSeat, String startDate,String finishDate, String registerOpen, String registerClose) {
        Events exist = findEventByName(eventName);
        if (exist != null) {
