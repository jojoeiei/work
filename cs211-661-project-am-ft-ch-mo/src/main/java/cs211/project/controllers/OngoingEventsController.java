...
//        eventDetailColumn.setCellValueFactory(new PropertyValueFactory<>("eventDetail"));
        ...
        TableColumn<Events, String> eventRegistrationEndDateColumn = new TableColumn<>("Register End Date");
        eventRegistrationEndDateColumn.setCellValueFactory(new PropertyValueFactory<>("eventRegistrationEndDate"));

        TableColumn<Events, String> seatAvailableColumn = new TableColumn<>("Seat Available");
        seatAvailableColumn.setCellValueFactory(new PropertyValueFactory<>("seatAvailable"));

        TableColumn<Events, String> seatTakenColumn = new TableColumn<>("Seat Taken");
        seatTakenColumn.setCellValueFactory(new PropertyValueFactory<>("seatTaken"));
...
//        eventsTableView.getColumns().add(eventDetailColumn);
        ...
        eventsTableView.getColumns().add(eventRegistrationEndDateColumn);
        eventsTableView.getColumns().add(seatAvailableColumn);
        eventsTableView.getColumns().add(seatTakenColumn);
