    ...
    public EventsList readData() {
        ...
        try {
            ...
            while ((line = buffer.readLine()) != null) {
                ...
                String finishDate = data[4].trim();
                String eventImagePath = data[5].trim();
                String eventCreatorUsername = data[6].trim();

                // เพิ่มข้อมูลลงใน list
                events.addNewEvent(eventName , eventDetail, maxSeat, startDate, finishDate, eventImagePath, eventCreatorUsername);
            }
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
